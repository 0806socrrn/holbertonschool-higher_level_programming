...
## Details
 By: Guillaume Weight: 1Project will startAug 16, 2022 12:00 AM, must end byAug 17, 2022 12:00 AMwill be released atAug 16, 2022 12:00 PM An auto review will be launched at the deadline## Resources
Read or watch :
...
* File:  ` 10-converter.js ` 
 Self-paced manual review  Panel footer - Controls 
### 11. Factor index
          #advanced         Progress vs Score  Task Body Write a script that imports an array and computes a new array.
...
### 12. Sorted occurences
          #advanced         Progress vs Score  Task Body Write a script that imports a dictionary of occurrences by user id and computes a dictionary of user ids by occurrence.
...
* File:  ` 101-sorted.js ` 
 Self-paced manual review  Panel footer - Controls 
### 13. Concat files
          #advanced         Progress vs Score  Task Body Write a script that concats 2 files.
